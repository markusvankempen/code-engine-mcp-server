...
if (!apiKey) {
    console.error('ERROR: IBMCLOUD_API_KEY not set');
    process.exit(1);
}
...
function callTool(name, args = {}) {
    return new Promise((resolve) => {
        ...
        proc.stdout.on('data', (d) => { stdout += d.toString(); tryResolve(); });
